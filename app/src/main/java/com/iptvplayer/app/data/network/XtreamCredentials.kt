    ...
    suspend fun getVodStreams(creds: XtreamCredentials, categoryId: String): List<Movie> {
        ...
        for (i in 0 until array.length()) {
            ...
            result += Movie(
                ...
                containerExtension = obj.optString("container_extension").takeIf { it.isNotBlank() } ?: "mp4"
            )
        }
        return result
    }
        ...
        while (seasonKeys.hasNext()) {
            ...
            for (i in 0 until seasonArray.length()) {
                ...
                result += Episode(
                    ...
                    containerExtension = ep.optString("container_extension").takeIf { it.isNotBlank() } ?: "mp4"
                )
            }
        }
